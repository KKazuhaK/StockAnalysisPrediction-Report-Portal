...
// Tabler Icons (MIT) 内嵌 SVG，模板用 {{icon "name"}} 调用。
var iconInner = map[string]string{
	...
	"report-analytics": `<path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2" />
...
func icon(name string) template.HTML {
	...
	return template.HTML(`<svg class="ti" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">` + p + `</svg>`)
}
